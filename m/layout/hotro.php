    ...
    <div id="footerSlideContent" style="height: 0px;">        
    	<div id="footerSlideText" style="display: block;">
			...
			<ul>
                    ...
                    <a rel="nofollow" href="ymsgr:sendIM?<?=$yahoo['yahoo']?>" title="<?=$yahoo['ten']?>"><img src="https://opi.yahoo.com/online?u=<?=$yahoo['yahoo']?>&m=g&t=7" width="30" title="<?=$yahoo['ten']?>" alt="<?=$yahoo['ten']?>" /> </a><b style="float:right;"><?=$yahoo['ten']?></b></span><span class="right"><?=$yahoo['dienthoai']?></span></li>
