...
https://w8tcha.github.com/CKEditor-oEmbed-Plugin/
...
####Installation
 ...
 1. Before you can use the plugin you also need to download & install the widget plugin, if you have it not installed. https://ckeditor.com/addon/widget
