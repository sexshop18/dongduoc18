CKEDITOR.plugins.setLang('bootstrapVisibility', 'en', {
	...
	classDetailsHtml: 'For an explanation of what the CSS classes listed above are check out Bootstrap 3\'s documentation at:<br> <a href="https://getbootstrap.com/css/#responsive-utilities" target="_blank">https://getbootstrap.com/css/#responsive-utilities</a>',
	none: 'None',
	hidden_xs: 'hidden-xs',
	hidden_sm: 'hidden-sm',
	hidden_md: 'hidden-md',
