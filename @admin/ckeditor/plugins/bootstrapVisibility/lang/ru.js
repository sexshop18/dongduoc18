CKEDITOR.plugins.setLang('bootstrapVisibility', 'ru', {
	...
	classDetailsHtml: 'Для объяснения классов CSS перечисленных выше, смотрите документацию Bootstrap 3 по адресу:<br> <a href="https://getbootstrap.com/css/#responsive-utilities" target="_blank">https://getbootstrap.com/css/#responsive-utilities</a>',
	 none: 'Ничего',
	hidden_xs: 'hidden-xs',
	hidden_sm: 'hidden-sm',
	hidden_md: 'hidden-md',
