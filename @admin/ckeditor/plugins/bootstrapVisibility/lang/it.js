CKEDITOR.plugins.setLang('bootstrapVisibility', 'it', {
	...
	classDetailsHtml: 'Per una spiegazione di ciò che le classi CSS elencati sopra, controllare la documentazione Bootstrap 3 a:<br> <a href="https://getbootstrap.com/css/#responsive-utilities" target="_blank">https://getbootstrap.com/css/#responsive-utilities</a>',
	none: 'Nessuno',
	hidden_xs: 'hidden-xs',
	hidden_sm: 'hidden-sm',
	hidden_md: 'hidden-md',
