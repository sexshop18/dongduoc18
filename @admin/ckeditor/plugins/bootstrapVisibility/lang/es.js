CKEDITOR.plugins.setLang('bootstrapVisibility', 'es', {
	...
	classDetailsHtml: 'Para una explicación las clases CSS mencionados anteriormente son echa un vistazo a la documentación del Bootstrap 3 en:<br> <a href="https://getbootstrap.com/css/#responsive-utilities" target="_blank">https://getbootstrap.com/css/#responsive-utilities</a>',
	none: 'Ninguno',
	hidden_xs: 'hidden-xs',
	hidden_sm: 'hidden-sm',
	hidden_md: 'hidden-md',
